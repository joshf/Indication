...
if (isset($_GET["email"]) && isset($_GET["hash"])) {
    ...
    $subject = "New Indication Password";
	$headers = "MIME-Version: 1.0\r\n";
    $headers .= "From: indication@" . $_SERVER["SERVER_NAME"] . "\r\n";
...
if (isset($_POST["email"])) {
    ...
    $subject = "Reset Your Indication Password";
	$headers = "MIME-Version: 1.0\r\n";
    $headers .= "From: indication@" . $_SERVER["SERVER_NAME"] . "\r\n";
	$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
    $message = "<html><body><p>Hi " . $userinforesult["user"] . ",</p><p>You have requested to reset your Indication password, to do so click <a href=\"$pathtoscript/reset.php?email=$to&hash=$hash\">here</a> and a new password will be emailed to you.</p><p>If you did not initiate this request, simply ignore this email.</p><p>Your welcome!<br>- The Admin</p></html></body>";
    if (mail($to, $subject, $message, $headers)) {
