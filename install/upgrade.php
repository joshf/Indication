...
if ($step == "0") {    
?>
<p>Welcome to Indication. You have just downloaded the newest version and your config file and database may need an unpgrade.</p>
...
<p>Indication has been successfully upgraded to version <?php echo $version; ?>.</p>
</div>
